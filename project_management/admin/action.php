<?php
    ...
    if(isset($_POST['login_button'])){
      ...
      if($log_password === $registered_password){
          ...
          header("Location: member_role.php");
          exit();
      }
    ...
    if(isset($_POST['assign_task'])){
        ...
        $associated_project_name = $_POST['associated_project_name'];
        ...
        $sql_project_id_query = mysqli_query($conn, "SELECT id FROM `project` WHERE name = '$associated_project_name' AND company_id = '$comp_id'");
